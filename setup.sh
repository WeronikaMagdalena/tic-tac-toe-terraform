...
sudo yum update -y
sudo yum install -y awscli git docker
HOME=/home/ec2-user
...
sudo su - ec2-user -c "git clone git@github.com:pwr-cloudprogramming/a5-WeronikaMagdalena.git"

cd home/ec2-user/a5-WeronikaMagdalena/
